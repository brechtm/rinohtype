...
def test_highlight():
    ...
    assert list(highlight(code, PythonLexer())) == \
        [Token('def', Keyword), Token(' ', Text),
         ...
         Token(indent + '    ', Text), Token('result', Name), Token(' ', Text),
           Token('=', Operator), Token(' ', Text), Token('[', Punctuation),
           Token(']', Punctuation), Token('\n', Text),
         Token(indent + '    ', Text), Token('result', Name),
           Token('.', Operator), Token('append', Name), Token('(', Punctuation),
           Token('bread', Name), Token('.', Operator), Token('slice', Name),
           Token('(', Punctuation), Token(')', Punctuation),
           Token(')', Punctuation), Token('\n', Text),
         Token(indent + '    ', Text), Token('if', Keyword), Token(' ', Text),
           Token('cheese', Name), Token(':', Punctuation), Token('\n', Text),
         Token(indent + '    ' + '    ', Text), Token('result', Name),
           Token('.', Operator), Token('append', Name), Token('(', Punctuation),
           Token("'", Literal.String), Token('cheese', Literal.String),
           Token("'", Literal.String), Token(')', Punctuation),
           Token('\n', Text),
         Token(indent + '    ', Text), Token('return', Keyword),
