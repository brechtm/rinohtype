...
# Written and put in the public domain by Ka-Ping Yee <ping@zesty.ca>
# See http://zestyping.livejournal.com/157957.html.
#
# Thanks Ka-Ping Yee!

## TODO: now part of Python, so use that instead
...
__date__ = '$Date: 2006/11/15 21:54:18 $'.split()[1].replace('/', '-')
